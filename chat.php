...
<button value="chat" id="btnSend" >chat</button>
  ...
  //using jquery on function to send msgs from dynamically created chatboxes
  ...
  //   var setContact_id=$('#contact_id').val();
  //   // alert("setContact id="+setContact_id);

  //   var contact_id=$(this).children('input').val();
  //   // alert("setting contact id="+contact_id);
  //   if(setContact_id==contact_id){
  //     // alert(setContact_id+" "+contact_id);
  //     $('#ChatArea').toggle();
  //     $('#chatbox').text("");
  //   }
  //   else{
...
$('body').on('click','.contact', function(){
  ...
  function getFriends(){
  setInterval( function() { getOnlineFriends(); }, 10000);
  }
